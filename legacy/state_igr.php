...
<title>States' IGR - <?php echo $userRow['state']; ?></title>
...
?></select>
          ...
          <tr>
            <td><h3>States' Internally Generated Revenue</h3></td>
...
?>
        ...
        <td><table width="100%" border="0" class="status_table" cellpadding="4" cellspacing="0">
          <tr>
                <td width="20%"><?php echo '<b>State: ' . $state . ' | Year:' . $year; ?></td>
                <th>Jan</th>
                <th>Feb</th>
                <th>Mar</th>
                <th>Apr</th>
  ...
  echo'     
              ...
              <tr>
                <td>PAYE</td>
                <td align="center">' . number_format($paye,2) . '</td>
				<td align="center">' . number_format($pfeb,2) . '</td>
				<td align="center">' . number_format($pmar,2) . '</td>
				<td align="center">' . number_format($papr,2) . '</td>
				<td align="center">' . number_format($pmay,2) . '</td>
				<td align="center">' . number_format($pjun,2) . '</td>
				<td align="center">' . number_format($pjul,2) . '</td>
				<td align="center">' . number_format($paug,2) . '</td>
				<td align="center">' . number_format($psep,2) . '</td>
				<td align="center">' . number_format($poct,2) . '</td>
				<td align="center">' . number_format($pnov,2) . '</td>
				<td align="center">' . number_format($pdec,2) . '</td>
              </tr>
              <tr>
                <td>Tax Audit/Back Duty</td>
                <td align="center">' . number_format($tax_audit,2) . '</td>
				<td align="center">' . number_format($tafeb,2) . '</td>
				<td align="center">' . number_format($tamar,2) . '</td>
				<td align="center">' . number_format($taapr,2) . '</td>
				<td align="center">' . number_format($tamay,2) . '</td>
				<td align="center">' . number_format($tajun,2) . '</td>
				<td align="center">' . number_format($tajul,2) . '</td>
				<td align="center">' . number_format($taaug,2) . '</td>
				<td align="center">' . number_format($tasep,2) . '</td>
				<td align="center">' . number_format($taoct,2) . '</td>
				<td align="center">' . number_format($tanov,2) . '</td>
				<td align="center">' . number_format($tadec,2) . '</td>
              </tr>
              <tr>
                <td>WHT (All)</td>
                <td align="center">' . number_format($wht,2) . '</td>
				<td align="center">' . number_format($whtfeb,2) . '</td>
				<td align="center">' . number_format($whtmar,2) . '</td>
				<td align="center">' . number_format($whtapr,2) . '</td>
				<td align="center">' . number_format($whtmay,2) . '</td>
				<td align="center">' . number_format($whtjun,2) . '</td>
				<td align="center">' . number_format($whtjul,2) . '</td>
				<td align="center">' . number_format($whtaug,2) . '</td>
				<td align="center">' . number_format($whtsep,2) . '</td>
				<td align="center">' . number_format($whtoct,2) . '</td>
				<td align="center">' . number_format($whtnov,2) . '</td>
				<td align="center">' . number_format($whtdec,2) . '</td>
              </tr>
              <tr>
                <td>Direct Assessment</td>
                <td align="center">' . number_format($direct_assess,2) . '</td>
				<td align="center">' . number_format($dafeb,2) . '</td>
				<td align="center">' . number_format($damar,2) . '</td>
				<td align="center">' . number_format($daapr,2) . '</td>
				<td align="center">' . number_format($damay,2) . '</td>
				<td align="center">' . number_format($dajun,2) . '</td>
				<td align="center">' . number_format($dajul,2) . '</td>
				<td align="center">' . number_format($daaug,2) . '</td>
				<td align="center">' . number_format($dasep,2) . '</td>
				<td align="center">' . number_format($daoct,2) . '</td>
				<td align="center">' . number_format($danov,2) . '</td>
				<td align="center">' . number_format($dadec,2) . '</td>
              </tr>
              <tr>
                <td>Direct Assessment (Informal Sector)</td>
                <td align="center">' . number_format($direct_informal,2) . '</td>
				<td align="center">' . number_format($difeb,2) . '</td>
				<td align="center">' . number_format($dimar,2) . '</td>
				<td align="center">' . number_format($diapr,2) . '</td>
				<td align="center">' . number_format($dimay,2) . '</td>
				<td align="center">' . number_format($dijun,2) . '</td>
				<td align="center">' . number_format($dijul,2) . '</td>
				<td align="center">' . number_format($diaug,2) . '</td>
				<td align="center">' . number_format($disep,2) . '</td>
				<td align="center">' . number_format($dioct,2) . '</td>
				<td align="center">' . number_format($dinov,2) . '</td>
				<td align="center">' . number_format($didec,2) . '</td>
              </tr>
              <tr>
                <td>Capital Gains Tax</td>
                <td align="center">' . number_format($capital_gain,2) . '</td>
				<td align="center">' . number_format($cgfeb,2) . '</td>
				<td align="center">' . number_format($cgmar,2) . '</td>
				<td align="center">' . number_format($cgapr,2) . '</td>
				<td align="center">' . number_format($cgmay,2) . '</td>
				<td align="center">' . number_format($cgjun,2) . '</td>
				<td align="center">' . number_format($cgjul,2) . '</td>
				<td align="center">' . number_format($cgaug,2) . '</td>
				<td align="center">' . number_format($cgsep,2) . '</td>
				<td align="center">' . number_format($cgoct,2) . '</td>
				<td align="center">' . number_format($cgnov,2) . '</td>
				<td align="center">' . number_format($cgdec,2) . '</td>
              </tr>
			  <tr>
                <td>MDA Revenues</td>
                <td align="center">' . number_format($mda_revenue,2) . '</td>
				<td align="center">' . number_format($mrfeb,2) . '</td>
				<td align="center">' . number_format($mrmar,2) . '</td>
				<td align="center">' . number_format($mrapr,2) . '</td>
				<td align="center">' . number_format($mrmay,2) . '</td>
				<td align="center">' . number_format($mrjun,2) . '</td>
				<td align="center">' . number_format($mrjul,2) . '</td>
				<td align="center">' . number_format($mraug,2) . '</td>
				<td align="center">' . number_format($mrsep,2) . '</td>
				<td align="center">' . number_format($mroct,2) . '</td>
				<td align="center">' . number_format($mrnov,2) . '</td>
				<td align="center">' . number_format($mrdec,2) . '</td>
              </tr>
              <tr>
                <td>Other Taxes/Levies/Charges</td>
                <td align="center">' . number_format($levies,2) . '</td>
				<td align="center">' . number_format($lfeb,2) . '</td>
				<td align="center">' . number_format($lmar,2) . '</td>
				<td align="center">' . number_format($lapr,2) . '</td>
				<td align="center">' . number_format($lmay,2) . '</td>
				<td align="center">' . number_format($ljun,2) . '</td>
				<td align="center">' . number_format($ljul,2) . '</td>
				<td align="center">' . number_format($laug,2) . '</td>
				<td align="center">' . number_format($lsep,2) . '</td>
				<td align="center">' . number_format($loct,2) . '</td>
				<td align="center">' . number_format($lnov,2) . '</td>
				<td align="center">' . number_format($ldec,2) . '</td>
              </tr>
              <tr>
                <td align="center"><b>TOTAL</b></td>
                <td align="center"><b>' . number_format($total,2) . '</b></td>
				<td align="center"><b>' . number_format($totalfeb,2) . '</b></td>
				<td align="center"><b>' . number_format($totalmar,2) . '</b></td>
				<td align="center"><b>' . number_format($totalapr,2) . '</b></td>
				<td align="center"><b>' . number_format($totalmay,2) . '</b></td>
				<td align="center"><b>' . number_format($totaljun,2) . '</b></td>
				<td align="center"><b>' . number_format($totaljul,2) . '</b></td>
				<td align="center"><b>' . number_format($totalaug,2) . '</b></td>
				<td align="center"><b>' . number_format($totalsep,2) . '</b></td>
				<td align="center"><b>' . number_format($totaloct,2) . '</b></td>
				<td align="center"><b>' . number_format($totalnov,2) . '</b></td>
				<td align="center"><b>' . number_format($totaldec,2) . '</b></td>
              </tr>
              <tr>
                <td align="center">&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>Taxpayer Registration No of TINs per JTB</td>
                <td align="center">' . number_format($taxpayer_reg) . '</td>
				<td align="center">' . number_format($trfeb) . '</td>
				<td align="center">' . number_format($trmar) . '</td>
				<td align="center">' . number_format($trapr) . '</td>
				<td align="center">' . number_format($trmay) . '</td>
				<td align="center">' . number_format($trjun) . '</td>
				<td align="center">' . number_format($trjul) . '</td>
				<td align="center">' . number_format($traug) . '</td>
				<td align="center">' . number_format($trsep) . '</td>
				<td align="center">' . number_format($troct) . '</td>
				<td align="center">' . number_format($trnov) . '</td>
				<td align="center">' . number_format($trdec) . '</td>
              </tr>
              <tr>
                <td>New Monthly TINs registered</td>
                <td align="center">' . number_format($monthly_tin) . '</td>
				<td align="center">' . number_format($mtfeb) . '</td>
				<td align="center">' . number_format($mtmar) . '</td>
				<td align="center">' . number_format($mtapr) . '</td>
				<td align="center">' . number_format($mtmay) . '</td>
				<td align="center">' . number_format($mtjun) . '</td>
				<td align="center">' . number_format($mtjul) . '</td>
				<td align="center">' . number_format($mtaug) . '</td>
				<td align="center">' . number_format($mtsep) . '</td>
				<td align="center">' . number_format($mtoct) . '</td>
				<td align="center">' . number_format($mtnov) . '</td>
				<td align="center">' . number_format($mtdec) . '</td>
              </tr>
              <tr>
                <td>No of Taxes/Levies Instruments amended/passed/signed in the month</td>
                <td align="center">' . number_format($num_levies) . '</td>
				<td align="center">' . number_format($nlfeb) . '</td>
				<td align="center">' . number_format($nlmar) . '</td>
				<td align="center">' . number_format($nlapr) . '</td>
				<td align="center">' . number_format($nlmay) . '</td>
				<td align="center">' . number_format($nljun) . '</td>
				<td align="center">' . number_format($nljul) . '</td>
				<td align="center">' . number_format($nlaug) . '</td>
				<td align="center">' . number_format($nlsep) . '</td>
				<td align="center">' . number_format($nloct) . '</td>
				<td align="center">' . number_format($nlnov) . '</td>
				<td align="center">' . number_format($nldec) . '</td>
              </tr>
              <tr>
                <td>Number of Tax Education Activities</td>
                <td align="center">' . number_format($num_education) . '</td>
				<td align="center">' . number_format($nefeb) . '</td>
				<td align="center">' . number_format($nemar) . '</td>
				<td align="center">' . number_format($neapr) . '</td>
				<td align="center">' . number_format($nemay) . '</td>
				<td align="center">' . number_format($nejun) . '</td>
				<td align="center">' . number_format($nejul) . '</td>
				<td align="center">' . number_format($neaug) . '</td>
				<td align="center">' . number_format($nesep) . '</td>
				<td align="center">' . number_format($neoct) . '</td>
				<td align="center">' . number_format($nenov) . '</td>
				<td align="center">' . number_format($nedec) . '</td>
              </tr>
              <tr>
                <td>Number of Tax Appeal Tribunal (TAT) cases</td>
                <td align="center">' . number_format($num_appeal) . '</td>
				<td align="center">' . number_format($nafeb) . '</td>
				<td align="center">' . number_format($namar) . '</td>
				<td align="center">' . number_format($naapr) . '</td>
				<td align="center">' . number_format($namay) . '</td>
				<td align="center">' . number_format($najun) . '</td>
				<td align="center">' . number_format($najul) . '</td>
				<td align="center">' . number_format($naaug) . '</td>
				<td align="center">' . number_format($nasep) . '</td>
				<td align="center">' . number_format($naoct) . '</td>
				<td align="center">' . number_format($nanov) . '</td>
				<td align="center">' . number_format($nadec) . '</td>
              </tr>
              <tr>
                <td>Number of Tax debt cases in Court</td>
                <td align="center">' . number_format($num_cases) . '</td>
				<td align="center">' . number_format($ncfeb) . '</td>
				<td align="center">' . number_format($ncmar) . '</td>
				<td align="center">' . number_format($ncapr) . '</td>
				<td align="center">' . number_format($ncmay) . '</td>
				<td align="center">' . number_format($ncjun) . '</td>
				<td align="center">' . number_format($ncjul) . '</td>
				<td align="center">' . number_format($ncaug) . '</td>
				<td align="center">' . number_format($ncsep) . '</td>
				<td align="center">' . number_format($ncoct) . '</td>
				<td align="center">' . number_format($ncnov) . '</td>
				<td align="center">' . number_format($ncdec) . '</td>
              </tr>
              <tr>
                <td>Number of HINWI Taxpayers</td>
                <td align="center">' . number_format($num_hinwi) . '</td>
				<td align="center">' . number_format($nhfeb) . '</td>
				<td align="center">' . number_format($nhmar) . '</td>
				<td align="center">' . number_format($nhapr) . '</td>
				<td align="center">' . number_format($nhmay) . '</td>
				<td align="center">' . number_format($nhjun) . '</td>
				<td align="center">' . number_format($nhjul) . '</td>
				<td align="center">' . number_format($nhaug) . '</td>
				<td align="center">' . number_format($nhsep) . '</td>
				<td align="center">' . number_format($nhoct) . '</td>
				<td align="center">' . number_format($nhnov) . '</td>
				<td align="center">' . number_format($nhdec) . '</td>
              </tr>
              <tr>
                <td>Number of Motor Vehicle Licenses Issued</td>
                <td align="center">' . number_format($num_license) . '</td>
				<td align="center">' . number_format($nlefeb) . '</td>
				<td align="center">' . number_format($nlemar) . '</td>
				<td align="center">' . number_format($nleapr) . '</td>
				<td align="center">' . number_format($nlemay) . '</td>
				<td align="center">' . number_format($nlejun) . '</td>
				<td align="center">' . number_format($nlejul) . '</td>
				<td align="center">' . number_format($nleaug) . '</td>
				<td align="center">' . number_format($nlesep) . '</td>
				<td align="center">' . number_format($nleoct) . '</td>
				<td align="center">' . number_format($nlenov) . '</td>
				<td align="center">' . number_format($nledec) . '</td>
              </tr>';
			 ...
			 //Render chart to page. hide chart
	//$chart->setTitle("" . $year . " State IGR Trend For " . $state . " State");
	//$chart->getPlot()->setGraphCaptionRatio(0.62);
	//$chart->render("libchart/demo/generated/demo10.png");
			  ?>
                        <!--  <img alt="Line chart"  src="libchart/demo/generated/demo10.png" /> -->
