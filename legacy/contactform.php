...
$formproc->AddRecipient('dnabena@nggovernorsforum.org'); //<<---Put your email address here


//2. For better security. Get a random tring from this link: http://tinyurl.com/randstr
// and put it here
$formproc->SetFormRandomKey('4OvR2uQUduFxHlr');
...
<title>NGF IGR Dashboard - Contact Form</title>
      <link rel="STYLESHEET" type="text/css" href="contact.css" />
      <script type='text/javascript' src='scripts/gen_validatorv31.js'></script>
</head>
<body leftmargin="500" topmargin="20">

<img src="images/NGF_logo.png" width="353" height="129" />
<!-- Form Code Start -->
...
<p class="myfooter">©2016 - 2017 Nigeria Governors' Forum </p>
</body>
</html>