    ...
    <td><table width="100%" border="0" class="inner_table">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="50%"><b>FOREWORD</b></td>
            <td align="right" class="mytopmenuhelp"><a href="#">Top</a><a href="overview.php">Next</a></td>
          </tr>
          <tr>
            <td colspan="2"><ul><li>The Nigeria Governors' Forum (NGF) IGR Dashboard was developed to provide retrieval of states' Internally Generated Revenue (IGR)  data, statistics and reports over the NGF website on the internet.</li><br />
            <li>NGF IGR Dashboard was developed utilizing Open Source .PHP framework (to work accross almost all browsers), Javascript, Cascading Style Sheets (CSS), MySQL Relational Database, and Apache and software plug-ins.</li><br />
            <li>NGF IGR Dashboard provides the mechanisms to accomodate Requests for states' Reports/Analytics (using <b>Index</b> searches), requests for <b>Performance Data</b> as well as the ability to retrieve, view, update, and work flow manage database information specific to Revenue Generation Reports.</li><br />
            <li>Users should have on their computer, Windows 98 (or later), IOS, or Linux. The computer should have a minimum of 32 megabytes of RAM and 
40 megabytes of free space.</li><br />
<li>A valid Username and Password are required for access to NGF IGR Dashboard and to the Dashboard's Administrative Console.</li>
            </ul></td>
            </tr>
        </table></td>
      </tr>
