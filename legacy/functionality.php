    ...
    <td><table width="100%" border="0" class="inner_table">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="50%"><b>FUNCTIONALITY</b></td>
            <td align="right" class="mytopmenuhelp"><a href="structure.php">Previous</a><a href="help.php">Top</a><a href="genreport.php">Next</a></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
            </tr>
