    ...
    <td><table width="100%" border="0" class="inner_table">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="50%"><b>NAVIGATION</b></td>
            <td align="right" class="mytopmenuhelp"><a href="genreport.php">Previous</a><a href="help.php">Top</a><a href="access.php">Next</a></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
            </tr>
