...
<div class="container shadow_bg">
    <h4>Total Recurrent Revenue (TRR) of States</h4>
            ...
            <table class="table table-bordered blue">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Last Recorded IGR <?php echo '('.$month.', '.$year.', N)'; ?></th>
                    </tr>
                    </thead>
                    <?php
...
$result1=mysqli_query($con, $sq2);
     ...
     <div class="d-flex table_list">
        <div class="table-wrapper">
            <div class="header-info justify-content-center"> 
            <div class="overflow-x">
            <table class="table table-bordered green" align="top">
                <thead>
                    <tr>
                        <th scope="col">State</th>
                        <th scope="col">Last Recorded FA <?php echo '('.$month.', '.$year.', N)'; ?></th>
                    </tr>
                    </thead>
                    <?php
    ...
    <div class="table-wrapper">
            ...
            <table class="table table-bordered red">
                <thead>
                    <tr>
                        <th scope="col">State</th>
                        <th scope="col">Last Recorded TRR <?php echo '('.$month.', '.$year.', N)'; ?></th>
                    </tr>
                    </thead>
                    <?php
...
<script>
    $('a[href="TotalRecurrentRevenue"]').addClass('active')
</script>
