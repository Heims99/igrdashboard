    ...
    <form class="form-inline mt-5 d-flex justify-content-between" id="form1" name="form1" method="post" action="#">
        <div class="d-flex">
            <div class="form-group mb-2">
                ...
                <select id="select_view" name="select_view" class="form-control">
                    <option value="overall" value="">OVERALL, CATEGORY</option>
                    
                </select>
            </div>
            <div class="form-group mx-sm-3 mb-2">
                <label for="zone" class="sr-only">Zone</label>
                <select id="zone" name="zone" size="1" class="form-control">
                    <?php 
$con=mysqli_connect("localhost","nggovern_Garki","NgfBassi1!","nggovern_dashboard");
//---------------------- check connection ------------------------
    if(mysqli_errno($con))
    ...
    <div class="d-flex table_list">
        <div class="table-wrapper">
            <div class="header-info justify-content-center">
                <span class="table_name text-danger">Tax Administrator <?php echo '<i>(Year: '.$year.')</i>'; ?></span>
            </div>
         ...
         $ranking = getRank($states,$taxAdminscores,$taxAdminDiff);
		   ...
		   for($i= 1; $i <= $rows; $i++)
           {
			   if(stripos($taxAdminDiff[$states[$i]], '-') !== FALSE){
                //echo '<tbody>';
                echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxAdminscores[$states[$i]],2) . '</td><td align="center"><font color="#FF0000">'. number_format($taxAdminDiff[$states[$i]],2) .'</font></td></tr>';
			   } else {
				   echo '<tr class="task-name">';
...
if($result === FALSE) { 
   die(mysqli_error($link)); // TODO: better error handling
	...
	?>
        ...
        <div class="table-wrapper">
            <div class="header-info justify-content-center">
                <span class="table_name">Tax Procedure <?php echo '<i>(Year: '.$year.')</i>'; ?></span>
            </div>
            <div class="overflow-x">
		...
		$ranking = getRank($states,$taxProcscores,$taxProcDiff);
		   ...
		   for($i= 1; $i <= $rows; $i++)
           {
			if(stripos($taxProcDiff[$states[$i]], '-') !== FALSE){
			  echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxProcscores[$states[$i]],2) . '</td><td align="center"><font color="#FF0000">' . number_format($taxProcDiff[$states[$i]],2) . '</font></td></tr>';
			} else {
				echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxProcscores[$states[$i]],2) . '</td><td align="center"><font color="#009900">' . number_format($taxProcDiff[$states[$i]],2) . '</font></td></tr>';
			}
		   }
			  ?>
                        <?php
...
if($result === FALSE) { 
   die(mysqli_error($link)); // TODO: better error handling
	...
	?>
        ...
        <div class="table-wrapper">
            <div class="header-info justify-content-center">
                <span class="table_name text-warning">Tax Processing <?php echo '<i>(Year: '.$year.')</i>'; ?></span>
            </div>
            <div class="overflow-x">
  ...
  $rows = 0;
   ...
   // }
		...
		if(stripos($taxProDiff[$states[$i]], '-') !== FALSE){
			  echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxProscores[$states[$i]],2) . '</td><td align="center"><font color="#FF0000">' . number_format($taxProDiff[$states[$i]],2) . '</font></td></tr>';
		} else {
			echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxProscores[$states[$i]],2) . '</td><td align="center"><font color="#009900">' . number_format($taxProDiff[$states[$i]],2) . '</font></td></tr>';
		   }
		   }
			  ?>
                        <?php
...
if($result === FALSE) { 
  die(mysqli_error($link)); // TODO: better error handling
	...
	?>
        ...
        <div class="table-wrapper">
            <div class="header-info justify-content-center">
                <span class="table_name">Tax Enforcement <?php echo '<i>(Year: '.$year.')</i>'; ?></span>
            </div>
            <div class="overflow-x">
  ...
  $rows = 0;
   ...
   // }
		...
		if(stripos($taxEnfoDiff[$states[$i]], '-') !== FALSE){
			  echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxEnfoscores[$states[$i]],2) . '</td><td align="center"><font color="#FF0000">' . number_format($taxEnfoDiff[$states[$i]],2) . '</font></td></tr>';
		} else {
			echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxEnfoscores[$states[$i]],2) . '</td><td align="center"><font color="#009900">' . number_format($taxEnfoDiff[$states[$i]],2) . '</font></td></tr>';
		}
		   }
			  ?>
                        <?php
...
if($result === FALSE) { 
   die(mysqli_error($link)); // TODO: better error handling
	...
	?>
        ...
        <div class="table-wrapper">
            <div class="header-info justify-content-center">
                <span class="table_name green">Overall Assesment <?php echo '<i>(Year: '.$year.')</i>'; ?></span>
            </div>
            <div class="overflow-x">
         ...
         $ranking = getRank($states,$taxOverscores,$taxOverDiff);
		   ...
		   for($i= 1; $i <= $rows; $i++)
           {
			   if(stripos($taxOverDiff[$states[$i]], '-') !== FALSE){
                echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxOverscores[$states[$i]],2) . '</td><td align="center"><font color="#FF0000">' . number_format($taxOverDiff[$states[$i]],2) . '</font></td></tr>';
			   } else {
				   echo '<tr>';
				echo '<td class="task-name">' . $ranking[$states[$i]] . '</td><td>' . $states[$i] . '</td><td>' . number_format($taxOverscores[$states[$i]],2) . '</td><td align="center"><font color="#009900">' . number_format($taxOverDiff[$states[$i]],2) . '</font></td></tr>';
			   }
		   }
			  ?>
              <?php
    ...
    <div class="d-flex table_list">
        <div class="chart_item_group shadow_bg">
            <div class="chart-wrapper">
                ...
                <div id="top_x_div" style="width: 550px; height: 500px;"></div>
            </div>
        </div>
        <div class="chart_item_group shadow_bg">
            <div class="chart-wrapper">
                <!--<div class="chart-title">Tax Processing</div>
                <div class="chart-subtitle">Governance Rating</div>-->
                <div id="top_y_div" style="width: 550px; height: 500px;"></div>
            </div>
        </div>
    </div>
    <div class="d-flex table_list">
        <div class="chart_item_group shadow_bg">
            <div class="chart-wrapper">
                <!--<div class="chart-title">Tax Processing</div>
                <div class="chart-subtitle">Governance Rating</div>-->
                <div id="top_z_div" style="width: 550px; height: 500px;"></div>
            </div>
        </div>
        <div class="chart_item_group shadow_bg">
            <div class="chart-wrapper">
                <!--<div class="chart-title">Tax Processing</div>
                <div class="chart-subtitle">Governance Rating</div>-->
                <div id="top_w_div" style="width: 550px; height: 500px;"></div>
            </div>
        </div>
    </div>
    <!--<div class="d-flex table_list">
