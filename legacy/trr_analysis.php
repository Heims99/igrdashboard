...
<title>IGR TRR Analysis - <?php echo $userRow['state']; ?></title>
...
?>
        ...
        <td valign="top" width="30%"><table width="100%" border="0" class="status_table" cellpadding="4" cellspacing="0">
          <tr>
     
                <th>State</th>
                <th>IGR <?php echo '('.$month.', '.$year.', N)'; ?></th>
                <th>IGR (∆, N)</th>
                <th>IGR (∆, %)</th>
                <th>IGR (% of TRR)</th>
              </tr>
  ...
  echo'     
        ...
        </table></td><td valign="top" width="30%">
...
$result1=mysqli_query($con, $sq2);
     ...
     <tr>
     <th>State</th>
     <th>FA <?php echo '('.$month.', '.$year.', N)'; ?></th>
     <th>FA (∆, N)</th>
     <th>FA (∆, %)</th>
     <th>FA (% of TRR)</th>
     </tr>
  ...
  while($rs1=@mysqli_fetch_array($result1, MYSQLI_NUM)){  
	...
	echo'     
        ...
        </td><td valign="top" width="30%"><table width="100%" border="0" class="status_table" cellpadding="4" cellspacing="0">
          <?php
 //include 'connection.php';
 $con=mysqli_connect("localhost","nggovern_Garki","NgfBassi1!","nggovern_dashboard");
// Check connection
...
$result2=mysqli_query($con, $sq3);
     ...
     ?>
          <tr>
            <th>State</th>
            <th>TRR <?php echo '('.$month.', '.$year.', N)'; ?></th>
            <th>TRR (∆, N)</th>
            <th>TRR (∆, %)</th>
          </tr>
          <?php
