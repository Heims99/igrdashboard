...
Select All</td>
          ...
          <tr class="">
			...
			<th width="12%"><strong>Username</strong></th>
            <th width="12%"><strong>State</strong></th>
			<th width="12%"><strong>Month</strong></th>
            <th width="10%"><strong>Year</strong></th>
            <th width="24%"><strong>Status</strong></th>
            <th width="15%"><strong>View Detail</strong></th>
          </tr>
		  <?php
...
//---------------------- check connection ------------------------
    ...
    {echo "</br>";}
		  $sql=mysqli_query($con, "SELECT users.username, users.state, annex.annexId, annex.mysession, annex.month, annex.year, annex.state, case annex.completed
...
WHERE users.username = annex.mysession");
          ...
          <tr class="status_tr">
            ...
            <td><a href="<?php echo "annex_edit.php?annexId=".$row['annexId']."&mode=update"; ?>"><?php echo $row['finalized']; ?></a></td>
            <td><a href="<?php echo "annex_view.php?annexId=".$row['annexId']."&mode=update"; ?>">View Detail</a></td>
          </tr>
		  <?php } ?>
