...
//---------------------- check connection ------------------------
    ...
    {echo "</br>";}
			...
			$sql=mysqli_query($con, "SELECT survey_id,tin_captured,reg_pack,new_tax,num_page,standard_form,paper_size,avail_public,pack_content,avail_req,avail_req1,avail_req2,avail_req3,avail_req4,avail_req5,avail_req6,guidance,avail_online,sbirs_assessment,self_assessment,self_assesscover,self_assesscover1,self_assesscover2,self_assesscover3,desk_guide,object_right,doc_appeal,referred,num_reg_taxpayer,tin_often_updated,make_assess,taxpayer_engage,target_setting,have_tin,pit_rates,validity FROM survey1 WHERE survey_id='$surveyid'");
...
<label>33a. Does the SIRS use a new and simplified tax return?</label><i> (This should not be the print of the return form that refers to allowances etc that are no longer applicable.)</i><br />
                    <input type="radio" name="new_tax" id="" value="4" required <?php if($new_tax=="4"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="new_tax" id="" value="1" <?php if($new_tax=="1"){ echo "checked";}?> ><i>No</i>
                    <br /><br />
                    <i>33b. If Yes, how many pages long?<br><input type="radio" name="num_page" value="6" required <?php if($num_page=="6"){ echo "checked";}?> >1 page<br />
                    ...
                    <input type="radio" name="standard_form" id="" value="4" required <?php if($standard_form=="4"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="standard_form" id="" value="1" <?php if($standard_form=="1"){ echo "checked";}?> ><i>No</i>
                    <br />
<i>33d. If yes, what is the form standard used?<br>
                    ...
                    <input type="radio" name="guidance" id="" value="4" required <?php if($guidance=="4"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="guidance" id="" value="1" <?php if($guidance=="1"){ echo "checked";}?> ><i>No</i>
                    <br /><br />
                    
                    <i>35b. If Yes do these include examples and PIT rates table to ease computation? And references to each box for clarity? If yes please be ready to share for peer learning<span>*</span><br />
...
<label>37. Are assessments almost always issued by the SIRS?<span>*</span></label><br />
                    ...
                    <input type="radio" name="doc_appeal" id="" value="4" required <?php if($doc_appeal=="4"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="doc_appeal" id="" value="1" <?php if($doc_appeal=="1"){ echo "checked";}?>><i>No</i>
                    <br /><br />
                    
                    <i>42b. If Yes does this process ensure that the same person who rasied the assessment does not decide on the final validity of the assessment? And Does the guidance make it clear that the taxpayer can ask that his/her objection is settled by going to court or the tax appeal tribunal?<span>*</span><br />
                    <input type="radio" name="validity" value="4" required <?php if($validity=="4"){ echo "checked";}?> >Yes<br />
                    <input type="radio" name="validity" value="1" <?php if($validity=="1"){ echo "checked";}?> >No</i>
                    <br /><br />
