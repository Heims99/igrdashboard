...
Select All</td>
          ...
          <tr class="">
            <th width="15%"><strong><a href="javascript:goDel()"><font color="#99FF99">Delete</font></a></strong></th>
...
//---------------------- check connection ------------------------
    ...
    {echo "</br>";}
		  $sql=mysqli_query($con, "SELECT faacYear
FROM faacMonthly
GROUP BY faacYear
ORDER BY faacYear");
		  //$result=mysqli_query($sql,$db) or die(mysql_error());
