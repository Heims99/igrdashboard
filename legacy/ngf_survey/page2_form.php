...
//---------------------- check connection ------------------------
    ...
    {echo "</br>";}
				$sql= mysqli_query ($con, "SELECT survey_id,tin_captured,reg_pack,new_tax,num_page,standard_form,paper_size,avail_public,pack_content,avail_req,avail_req1,avail_req2,avail_req3,avail_req4,avail_req5,avail_req6,guidance,avail_online,sbirs_assessment,self_assessment,self_assesscover,self_assesscover1,self_assesscover2,self_assesscover3,desk_guide,object_right,doc_appeal,referred,num_reg_taxpayer,tin_often_updated,make_assess,taxpayer_engage,target_setting,have_tin,pit_rates,validity FROM survey1,users WHERE mysession='$userRow[username]'");
		...
		?>
                ...
                <form action="page2_insertdata.php" method="post" novalidate>
...
<i id="paper_size" style="display:none;">33d. If yes, what is the form standard used?<br>
                    ...
                    <input type="checkbox" name="avail_req6" value="1" <?php if($avail_req6=="1"){ echo "checked";}?> ><i>Other</i>
                    <br /><br />
