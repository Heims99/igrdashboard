    ...
    {echo "</br>";}
		...
		?>
               ...
               <input name="surveyid" type="text" value="<?php echo $surveyid; ?>" hidden="true"  >
                <input name="mysession" type="text" value="<?php echo $mysession . ' State'; ?>" readonly >
...
<label><i>Top management of SIRS plus non-SIRS members?</i><span>*</span></label><br />
                    <input type="radio" name="sbirs_mship_toplus" id="" value="yes" <?php if($sbirs_mship_toplus=="yes"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="sbirs_mship_toplus" id="" value="no" <?php if($sbirs_mship_toplus=="no"){ echo "checked";}?> ><i>No</i>
                    <br /><br>
                    <i>If Yes, who are the external members?<br />
...
<label>11a. What is the number of the SIRS employees?<span>*</span></label><br />
                   ...
                   <input type="radio" name="attended_training" value="3" <?php if($attended_training=="3"){ echo "checked";}?> ><i>Last year</i><br />
                    ...
                    <input type="radio" name="trainin_program" id="" value="4" <?php if($trainin_program=="4"){ echo "checked";}?> ><i>All staff</i><br />
                    <input type="radio" name="trainin_program" id="" value="3" <?php if($trainin_program=="3"){ echo "checked";}?> ><i>Technical staff only</i><br />
                    <input type="radio" name="trainin_program" id="" value="0" <?php if($trainin_program=="0"){ echo "checked";}?> ><i>Ad-hoc</i>
                    <br /><br>
                    <i>14b. What is the minimum number of trainings per staff to be attended annually: 1, 2, 3 or 4. <input name="min_training" type="number" placeholder="Integer number" value="<?php echo $min_training; ?>" ></i><br>
                    ...
                    <input type="radio" name="perform_app" id="" value="3"   <?php if($perform_app=="3"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="perform_app" id="" value="1" <?php if($perform_app=="1"){ echo "checked";}?>><i>No</i>
                    <br />
                    
                    <i>16b. If Yes, How often?<br />
                    ...
                    <input type="radio" name="contract_staff" id="" value="1" <?php if($contract_staff=="1"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="contract_staff" id="" value="3" <?php if($contract_staff=="3"){ echo "checked";}?> ><i>No</i>
                    <br /><br>
                    <i>18b. If yes, how many?<br />
                   ...
                   <input name="num_political" type="number" placeholder="Integer number" value="<?php echo $num_political; ?>" >
                    ...
                    <input type="radio" name="ad_hoc" id="" value="yes" <?php if($ad_hoc=="yes"){ echo "checked";}?> ><i>Yes</i><br />
                    <input type="radio" name="ad_hoc" id="" value="no" <?php if($ad_hoc=="no"){ echo "checked";}?> ><i>No</i>
                    <br /><br>
                    <i>20b. If yes, how many?<br />
                   <input name="num_adhoc" type="number" placeholder="Integer number" value="<?php echo $num_adhoc; ?>" ></i>
                    <br />
                    <i>20c. What task(s) do they carry out?<br />
...
<label>21. How many field offices does the SIRS have?<span>*</span></label><br /><input type="number" name="num_offices" placeholder="Integer number" value="<?php echo $num_offices; ?>" >
                    ...
                    <input type="radio" name="function_website" id="" value="3" <?php if($function_website=="3"){ echo "checked";}?> ><i>Yes</i><br>
                    <input type="radio" name="function_website" id="" value="1" <?php if($function_website=="1"){ echo "checked";}?> ><i>No</i>
                    <br>
                    <i>26b. If yes, which of these are domiciled on the website? (tick as apply)<br />
